                                  ...
                                  <li>
                                    <div class="row">
                                        <div class="col-sm-12 text-center">
                                            <form class="form" role="form" method="post" action="index.php" accept-charset="UTF-8">
                                                <div class="form-group">
                                                    <label class="sr-only" for="fname">FullName</label>
                                                    <input type="text" name="register_fname" class="form-control"  placeholder="FullName" required>
                                                </div>
                                                <div class="form-group">
                                                    <label class="sr-only" for="username">Username</label>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="register_phno" class="form-control"  placeholder="PhoneNumber" required>
                                                </div>
                                                <div class="form-group">
...
$query="select * from book  where isbn like '%{$keyword}%' OR title like '%{$keyword}%' OR bauthor like '%{$keyword}%' OR publisher like '%{$keyword}%' OR bcategory like '%{$keyword}%'";
