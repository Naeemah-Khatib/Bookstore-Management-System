...
<body>
    ...
    {
        if($_POST['sort']=="price")
                {   $query = "SELECT * FROM book WHERE bcategory='$category' ORDER BY price";
        ...
        if($_POST['sort']=="priceh")
                {   $query = "SELECT * FROM book WHERE bcategory='$category' ORDER BY price DESC";
                    $result = mysqli_query ($con,$query)or die(mysqli_error($con));
                }
        
    } 
    else   
            {   $query = "SELECT * FROM book WHERE bcategory='$category'";
                $result = mysqli_query ($con,$query)or die(mysqli_error($con));
            } 
    $i=0;
