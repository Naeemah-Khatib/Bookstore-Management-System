...
<body>
    ...
    {
        if($_POST['sort']=="price")
                {   $query = "SELECT * FROM book WHERE bauthor='$author' ORDER BY price";
                    $result = mysqli_query ($con,$query)or die(mysqli_error($con));
                }
        else
        if($_POST['sort']=="priceh")
                {   $query = "SELECT * FROM book WHERE bauthor='$author' ORDER BY price DESC";
                    $result = mysqli_query ($con,$query)or die(mysqli_error($con));
                }
        
    } 
    else   
                  $query = "SELECT * FROM book WHERE bauthor='$author'";
